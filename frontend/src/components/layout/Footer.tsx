        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Find & List Rental Properties with Ease. Connecting verified landlords and tenants with seamless booking and secure payments.
            </p>
          </div>

          {/* Tenants Links */}
          <div className="space-y-3">
            <h4 className="text-sm font-bold text-white uppercase tracking-wider">Tenants</h4>
          ...
          {/* Landlords Links */}
          <div className="space-y-3">
            <h4 className="text-sm font-bold text-white uppercase tracking-wider">Landlords</h4>
            <ul className="space-y-2 text-sm">
              <li>
              ...
              <li>
                <Link href="/dashboard/landlord/properties/new" className="hover:text-white transition-colors">
                  Add New Property
                </Link>
              </li>
              <li>
                <Link href="/dashboard/landlord/requests" className="hover:text-white transition-colors">
                  Manage Requests
                </Link>
              </li>
              <li>
